...
public class Main { // Класс для тестирование работы классов менеджер и задач.
    public static void main(String[] args) {
        ...
        Epic epic1= new Epic("сделать проект 2го спринта","написать код отвечающий требованиям ревьюера",1,true,false,false);
        SubTask subTask1 = new SubTask("изучить ТЗ","ознакомится с требованиями проекта",1, true,false,false);
        SubTask subTask2 = new SubTask("написать код","создать логику отвечающую требованиям ТЗ",2,true,false,false);
        Epic epic2 = new Epic("отдохнуть","набраться сил перед новой рабочей неделей",2,true,false,false);
        SubTask subTask3 = new SubTask("выспаться", "пораньше лечь попозже встать",1,true,false,false);
