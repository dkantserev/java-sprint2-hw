...
class InMemoryHistoryManagerTest {
    ...
    Task task = new Task(TypeTask.TYPE_TASK, "testTask1", "...", 1, Status.TASK_NEW
            , ZonedDateTime.of(LocalDateTime.of(2028, 1, 1, 21, 1), zoneId)
            , Duration.ofHours(3));
    Task task1 = new Task(TypeTask.TYPE_TASK, "testTask2", "...", 2, Status.TASK_NEW
            , ZonedDateTime.of(LocalDateTime.of(2027, 1, 1, 21, 1), zoneId)
            , Duration.ofHours(3));
    Task task3 = new Task(TypeTask.TYPE_TASK, "testTask3", "...", 3, Status.TASK_NEW
            , ZonedDateTime.of(LocalDateTime.of(2026, 1, 1, 21, 1), zoneId)
            , Duration.ofHours(3));
    Task task4 = new Task(TypeTask.TYPE_TASK, "testTask4", "...", 4, Status.TASK_NEW
